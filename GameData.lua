...
GameData.TripleQuest = {
    ["2753915549"] = {
        [1] = (function()
            ...
            if game.Players.LocalPlayer.Team.Name == "Pirates" then
                gg = {
                    ["Quest"] = "BanditQuest1",
                    QuestCFrame = CFrame.new(1045.9626464844, 27.002508163452, 1560.8203125),
                    [1] = {
                        Requirement = 1,
                        Mob = "Bandit [Lv. 5]",
                        QuestCheck = "Bandit",
        ...
        [10] = {
            ["Quest"] = "JungleQuest",
            QuestCFrame = CFrame.new(-1598.08911, 35.5501175, 153.377838),
            [1] = {
                Requirement = 10,
                Mob = "Monkey [Lv. 30]",
                QuestCheck = "Monkey",
        ...
        [30] = {
            ["Quest"] = "BuggyQuest1",
            QuestCFrame = CFrame.new(-1141.07483, 4.10001802, 3831.5498),
            [1] = {
                Requirement = 30,
                Mob = "Pirate [Lv. 35]",
                QuestCheck = "Pirate",
        ...
        [60] = {
            ["Quest"] = "DesertQuest",
            QuestCFrame = CFrame.new(894.488647, 5.14000702, 4392.43359),
            [1] = {
                Requirement = 60,
                Mob = "Desert Bandit [Lv. 60]",
                QuestCheck = "Desert Bandit",
            },
            [2] = {
                Requirement = 75,
                Mob = "Desert Officer [Lv. 75]",
                QuestCheck = "Desert Officer",
            }
        },
        [90] = {
            ["Quest"] = "SnowQuest",
            QuestCFrame = CFrame.new(1389.74451, 88.1519318, -1298.90796),
            [1] = {
                Requirement = 90,
                Mob = "Snow Bandit [Lv. 90]",
                QuestCheck = "Snow Bandit",
            },
            [2] = {
                Requirement = 100,
                Mob = "Snowman [Lv. 100]",
        ...
        [120] = {
            ["Quest"] = "MarineQuest2",
            QuestCFrame = CFrame.new(-5039.58643, 27.3500385, 4324.68018),
            [1] = {
                Requirement = 120,
                Mob = "Chief Petty Officer [Lv. 120]",
                QuestCheck = "Chief Petty Officer",
            },
            [2] = {
                Requirement = 130,
...
GameData.SpawnPosition = {
    ["2753915549"] = {
        ["Pirate [Lv. 35]"] = {"-1148.58569, 59.0819817, 3995.50439", "-1044.32031, 63.4753914, 3932.67212", "-1249.40833, 44.7819672, 3819.37158"},
        ["Desert Officer [Lv. 75]"] = {"874.814941, 30.1473866, 4485.71094", "1608.2822265625, 8.6142244338989, 4371.0073242188"},
